import{r as n,j as e,H as l}from"./index-CoTKg70n.js";import c from"./Footer-BVRx9TOZ.js";const p="/siingulo/assets/logo-escala-8Fp2n4u0.png",s=[{id:"introducao",titulo:"Introdução",conteudo:`
    ...
    `},{id:"informacoes-gerais",titulo:"Informações gerais",conteudo:`
    ...
    `},{id:"dados-coletados",titulo:"DADOS PESSOAIS COLETADOS E SUA UTILIZAÇÃO",conteudo:`
    ...
    `},{id:"tratamento-de-dados",titulo:"TRATAMENTO E COMPARTILHAMENTO DOS DADOS PESSOAIS",conteudo:`
    ...
    `},{id:"seguranca",titulo:"SEGURANÇA DOS DADOS PESSOAIS",conteudo:`
    ...
    `},{id:"uso-de-cookies",titulo:"USO DE COOKIES",conteudo:`
    ...
    `},{id:"politica-de-cookies",titulo:"POLÍTICA DE COOKIES",conteudo:`
    ...
    `},{id:"alteracoes",titulo:"ALTERAÇÕES A ESTA POLÍTICA",conteudo:`
    ...
    `},{id:"direitos-dos-titulares",titulo:"DIREITOS DOS TITULARES",conteudo:`
    ...
    `},{id:"responsavel",titulo:"RESPONSÁVEL PELO TRATAMENTO DE DADOS",conteudo:`
    ...
    `},{id:"contato",titulo:"CONTATO",conteudo:`
    ...
    `}];function g(){const[r,t]=n.useState(s[0].id);n.useEffect(()=>{const o=window.location.hash?window.location.hash.slice(1):"";o&&s.some(a=>a.id===o)&&(t(o),requestAnimationFrame(()=>{const a=document.getElementById(o);a&&a.scrollIntoView({behavior:"smooth",block:"start"})})),window.scrollTo({top:0,behavior:"instant"})},[]),n.useEffect(()=>{const o=()=>{const a=window.location.hash?window.location.hash.slice(1):"";if(s.some(i=>i.id===a)){t(a);const i=document.getElementById(a);i&&i.scrollIntoView({behavior:"smooth",block:"start"})}};return window.addEventListener("hashchange",o),()=>window.removeEventListener("hashchange",o)},[]);const d=o=>{t(a=>a===o?null:o)};return e.jsxs(e.Fragment,{children:[e.jsxs("main",{className:"pp",children:[e.jsxs("section",{className:"pp-top",style:{"--hero-politica":`url(${p})`,marginTop:"-16px"},children:[e.jsx(l,{}),e.jsx("div",{className:"pp-hero",children:e.jsxs("div",{className:"pp-hero-inner",children:[e.jsx("h1",{className:"pp-title",children:"PDP"}),e.jsx("p",{className:"pp-sub",children:"Política de Privacidade e Proteção de Dados"})]})})]}),e.jsx("section",{className:"pp-content container",children:e.jsx("div",{className:"pp-accordion",role:"tablist","aria-label":"Política de Privacidade",children:s.map(o=>{const a=r===o.id;return e.jsxs("article",{id:o.id,className:`pp-item ${a?"is-open":""}`,children:[e.jsx("h2",{className:"pp-item-title",children:e.jsxs("button",{className:"pp-trigger",role:"tab","aria-expanded":!!a,"aria-controls":`panel-${o.id}`,onClick:()=>d(o.id),children:[e.jsx("span",{children:o.titulo}),e.jsx("svg",{className:"chev",width:"20",height:"20",viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{d:"M7 10l5 5 5-5",fill:"none",stroke:"currentColor",strokeWidth:"2"})})]})}),e.jsx("div",{id:`panel-${o.id}`,role:"region","aria-labelledby":o.id,className:"pp-panel",hidden:!a,children:e.jsx("div",{className:"pp-panel-inner",dangerouslySetInnerHTML:{__html:o.conteudo}})})]},o.id)})})})]}),e.jsx(c,{})]})}export{g as default};
